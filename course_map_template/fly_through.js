...
export function initFlyThrough(map, pathPoints, onProgress, options) {
    var SPEED = options?.speed || 1200;
    var CAM_ABOVE = options?.camAbove || 3000;
    var EARTH_CIRC = 40075016.686;
    var HEADING_FORWARD = SPEED * 2;
    var LOOK_AHEAD = SPEED * 2;
    var LERP_RATE = 3;
    var FLY_PITCH = options?.pitch || 45;
    var dotColor = options?.dotColor || '#ff3366';
    var dotStroke = options?.dotStroke || '#ffffff';
