...
function makeTextCanvas(label, bgColor, fgColor) {
...
export function createTorusLayer(map, pathPoints, waypoints, colors) {
    const bgColor = colors?.bgColor || '#ff3366';
    const fgColor = colors?.fgColor || '#ffffff';
    ...
    return {
        ...
        onAdd: function(m, gl) {
            ...
            for (const def of ringDefs) {
                ...
                gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, makeTextCanvas(def.label, bgColor, fgColor));
